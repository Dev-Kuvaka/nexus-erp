...
from nexuserp.crm.doctype.lead.lead import make_customer
from nexuserp.crm.doctype.lead.test_lead import make_lead
from nexuserp.crm.doctype.opportunity.opportunity import make_quotation
from nexuserp.crm.utils import get_linked_communication_list
from nexuserp.tests.utils import nexuserpTestSuite


class TestOpportunity(nexuserpTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
