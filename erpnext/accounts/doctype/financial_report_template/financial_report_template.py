...
from nexuserp.accounts.doctype.account_category.account_category import import_account_categories
from nexuserp.accounts.doctype.financial_report_template.financial_report_validation import TemplateValidator
...
class FinancialReportTemplate(Document):
	...
	if TYPE_CHECKING:
		...
		from nexuserp.accounts.doctype.financial_report_row.financial_report_row import FinancialReportRow
	...
	def _export_account_categories(self):
		...
		from nexuserp.accounts.doctype.financial_report_template.financial_report_engine import (
...
def sync_financial_report_templates(chart_of_accounts=None, existing_company=None):
	from nexuserp.accounts.doctype.account.chart_of_accounts.chart_of_accounts import get_chart
	...
	# Allow regional templates to completely override nexuserp
	...
	for app in installed_apps:
		if disable_default_financial_report_template and app == "nexuserp":
			continue
