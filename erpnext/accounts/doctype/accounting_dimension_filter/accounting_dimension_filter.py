...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from nexuserp.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from nexuserp.accounts.doctype.applicable_on_account.applicable_on_account import ApplicableOnAccount
