...
frappe.provide("nexuserp.cheque_print");
	...
	refresh: function (frm) {
		if (!frm.doc.__islocal) {
			frm.add_custom_button(
				...
				function () {
					nexuserp.cheque_print.view_cheque_print(frm);
				}
...
nexuserp.cheque_print.view_cheque_print = function (frm) {
	frappe.call({
		method: "nexuserp.accounts.doctype.cheque_print_template.cheque_print_template.create_or_update_cheque_print_format",
		args: {
