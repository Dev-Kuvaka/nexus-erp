...
import nexuserp
from nexuserp.accounts.doctype.journal_entry.journal_entry import get_balance_on
from nexuserp.accounts.utils import get_currency_precision
...
class ExchangeRateRevaluation(Document):
	...
	if TYPE_CHECKING:
		...
		from nexuserp.accounts.doctype.exchange_rate_revaluation_account.exchange_rate_revaluation_account import (
...
def get_account_details(
	...
	account_details = {}
	nexuserp.get_company_currency(company)
