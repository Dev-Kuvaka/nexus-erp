...
from nexuserp.accounts.doctype.pos_invoice.pos_invoice import make_sales_return
from nexuserp.accounts.doctype.pos_profile.test_pos_profile import make_pos_profile
from nexuserp.accounts.doctype.sales_invoice.sales_invoice import PartialPaymentValidationError
...
class TestPOSInvoice(IntegrationTestCase):
	...
	def setUpClass(cls):
		...
		from nexuserp.accounts.doctype.pos_closing_entry.test_pos_closing_entry import init_user_and_profile
		from nexuserp.accounts.doctype.pos_opening_entry.test_pos_opening_entry import create_opening_entry
	...
	def test_loyalty_points(self):
		...
		from nexuserp.accounts.doctype.loyalty_program.test_loyalty_program import create_records
	...
	def test_merging_into_sales_invoice_with_discount(self):
		from nexuserp.accounts.doctype.pos_closing_entry.test_pos_closing_entry import (
			init_user_and_profile,
		)
		from nexuserp.accounts.doctype.pos_invoice_merge_log.pos_invoice_merge_log import (
	...
	def test_ignore_pricing_rule(self):
		from nexuserp.accounts.doctype.pricing_rule.test_pricing_rule import make_pricing_rule
	...
	def test_delivered_serial_no_case(self):
		from nexuserp.accounts.doctype.pos_invoice_merge_log.test_pos_invoice_merge_log import (
			init_user_and_profile,
		)
	...
	def test_bundle_stock_availability_validation(self):
		from nexuserp.accounts.doctype.pos_invoice.pos_invoice import ProductBundleStockValidationError
		from nexuserp.accounts.doctype.pos_invoice_merge_log.test_pos_invoice_merge_log import (
			init_user_and_profile,
		)
