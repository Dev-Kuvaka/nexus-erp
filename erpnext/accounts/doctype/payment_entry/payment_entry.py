...
import nexuserp
from nexuserp.accounts.doctype.accounting_dimension.accounting_dimension import get_dimensions
from nexuserp.accounts.doctype.bank_account.bank_account import (
	get_bank_account_details,
	get_default_company_bank_account,
	get_party_bank_account,
)
from nexuserp.accounts.doctype.invoice_discounting.invoice_discounting import (
	get_party_account_based_on_invoice_discounting,
)
from nexuserp.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
...
from nexuserp.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from nexuserp.accounts.doctype.advance_taxes_and_charges.advance_taxes_and_charges import (
			AdvanceTaxesandCharges,
		)
		from nexuserp.accounts.doctype.payment_entry_deduction.payment_entry_deduction import (
			PaymentEntryDeduction,
		)
		from nexuserp.accounts.doctype.payment_entry_reference.payment_entry_reference import (
	...
	def update_payment_requests(self, cancel=False):
		from nexuserp.accounts.doctype.payment_request.payment_request import (
	...
	def set_transaction_currency_and_rate(self):
		company_currency = nexuserp.get_company_currency(self.company)
...
def get_reference_details(
	...
	company_currency = ref_doc.get("company_currency") or nexuserp.get_company_currency(ref_doc.company)
