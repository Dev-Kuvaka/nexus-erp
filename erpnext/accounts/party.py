...
from nexuserp.exceptions import InvalidAccountCurrency, PartyDisabled, PartyFrozen
...
def set_taxes(
	...
	from nexuserp.accounts.doctype.tax_rule.tax_rule import get_party_details, get_tax_template
