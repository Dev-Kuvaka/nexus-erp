...
import nexuserp
from nexuserp.accounts.report.balance_sheet.balance_sheet import (
	get_chart_data,
...
from nexuserp.accounts.report.cash_flow.cash_flow import (
	add_total_row_account,
	get_account_type_based_gl_data,
	get_cash_flow_accounts,
)
from nexuserp.accounts.report.cash_flow.cash_flow import get_report_summary as get_cash_flow_summary
from nexuserp.accounts.report.financial_statements import (
	filter_out_zero_value_rows,
	get_fiscal_year_data,
	sort_accounts,
)
from nexuserp.accounts.report.profit_and_loss_statement.profit_and_loss_statement import (
...
from nexuserp.accounts.report.utils import convert, convert_to_presentation_currency
from nexuserp.accounts.utils import get_zero_cutoff
...
def get_columns(companies, filters):
	...
	for company in companies:
		...
		if not currency:
			currency = nexuserp.get_company_currency(company)
			...
			if d:
				...
				for company in companies:
					...
					if (
						...
						parent_company_currency = nexuserp.get_company_currency(d.company)
						child_company_currency = nexuserp.get_company_currency(entry.company)
