...
class TransactionDeletionRecord(Document):
	...
	if TYPE_CHECKING:
		...
		from nexuserp.accounts.doctype.transaction_deletion_record_details.transaction_deletion_record_details import (
			TransactionDeletionRecordDetails,
		)
		from nexuserp.setup.doctype.transaction_deletion_record_item.transaction_deletion_record_item import (
