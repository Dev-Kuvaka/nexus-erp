...
frappe.provide("nexuserp.setup");
nexuserp.setup.EmployeeController = class EmployeeController extends frappe.ui.form.Controller {
	setup() {
...
frappe.ui.form.on("Employee", {
	...
	create_user: function (frm) {
		...
		frappe.call({
			method: "nexuserp.setup.doctype.employee.employee.create_user",
			args: {
...
cur_frm.cscript = new nexuserp.setup.EmployeeController({
	frm: cur_frm,
});
