...
import nexuserp
from nexuserp.accounts.utils import build_qb_match_conditions
from nexuserp.setup.doctype.employee.employee import InactiveEmployeeStatusError
		...
		employee = frappe.get_doc(
			{
				...
				"naming_series": "EMP-",
				"first_name": user,
				"company": company or nexuserp.get_default_company(),
				"user_id": user,
