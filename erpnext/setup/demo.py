...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "nexuserp")
	try:
		...
		capture("demo_data_creation_failed", "nexuserp", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "nexuserp")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "nexuserp")
	try:
...
def make_transactions(company):
	...
	from nexuserp.accounts.utils import FiscalYearError
