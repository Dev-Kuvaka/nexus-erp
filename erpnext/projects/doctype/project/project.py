...
from nexuserp import get_default_company
from nexuserp.controllers.queries import get_filters_cond
from nexuserp.controllers.website_list_for_contact import get_customers_suppliers
from nexuserp.setup.doctype.holiday_list.holiday_list import is_holiday
...
class Project(Document):
	...
	if TYPE_CHECKING:
		...
		from nexuserp.projects.doctype.project_user.project_user import ProjectUser
