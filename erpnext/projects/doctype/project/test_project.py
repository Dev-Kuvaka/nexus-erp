...
from nexuserp.projects.doctype.project_template.test_project_template import make_project_template
from nexuserp.projects.doctype.task.test_task import create_task
from nexuserp.selling.doctype.sales_order.sales_order import make_project as make_project_from_so
...
class TestProject(nexuserpTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
		cls.make_projects()
	...
	def test_project_total_costing_and_billing_amount(self):
		from nexuserp.projects.doctype.timesheet.test_timesheet import make_timesheet
