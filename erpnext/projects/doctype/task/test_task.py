...
from nexuserp.projects.doctype.task.task import CircularReferenceError, ParentIsGroupError
from nexuserp.tests.utils import nexuserpTestSuite


class TestTask(nexuserpTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
		cls.make_projects()
	...
	def test_overdue(self):
		...
		from nexuserp.projects.doctype.task.task import set_tasks_as_overdue
