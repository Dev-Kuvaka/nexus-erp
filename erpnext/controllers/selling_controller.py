...
from nexuserp.accounts.party import render_address
...
from nexuserp.stock.doctype.item.item import set_item_default
from nexuserp.stock.get_item_details import get_bin_details, get_conversion_factor
from nexuserp.stock.utils import get_combine_datetime, get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from nexuserp.accounts.party import _get_party_details
			...
			from nexuserp.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from nexuserp.controllers.buying_controller import validate_item_type
