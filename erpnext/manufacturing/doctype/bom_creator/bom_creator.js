...
frappe.ui.form.on("BOM Creator", {
	...
	make_new_entry(frm) {
		...
		dialog.fields_dict.item_code.get_query = "nexuserp.controllers.queries.item_query";
		dialog.show();
	},
...
nexuserp.bom.BomConfigurator = class BomConfigurator extends nexuserp.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new nexuserp.bom.BomConfigurator({ frm: cur_frm }));
