...
from nexuserp.support.doctype.issue.issue import get_holidays
...
class Workstation(Document):
	...
	if TYPE_CHECKING:
		...
		from nexuserp.manufacturing.doctype.workstation_cost.workstation_cost import WorkstationCost
		from nexuserp.manufacturing.doctype.workstation_working_hour.workstation_working_hour import (
