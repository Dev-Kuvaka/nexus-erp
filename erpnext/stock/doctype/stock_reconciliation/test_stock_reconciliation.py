...
# nexuserp - web based ERP (http://nexuserp.com)
...
from nexuserp.accounts.utils import get_stock_and_account_balance
...
from nexuserp.stock.stock_ledger import get_previous_sle, update_entries_after
from nexuserp.stock.tests.test_utils import StockTestMixin
from nexuserp.stock.utils import (
...
class TestStockReconciliation(IntegrationTestCase, StockTestMixin):
	...
	def test_backdated_stock_reco_future_negative_stock(self):
		...
		from nexuserp.stock.stock_ledger import NegativeStockError
