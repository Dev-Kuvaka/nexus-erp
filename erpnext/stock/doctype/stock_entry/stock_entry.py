...
import nexuserp
from nexuserp.accounts.general_ledger import process_gl_map
from nexuserp.accounts.utils import get_account_currency
from nexuserp.buying.utils import check_on_hold_or_closed_status
from nexuserp.controllers.taxes_and_totals import init_landed_taxes_and_totals
from nexuserp.manufacturing.doctype.bom.bom import (
	add_additional_cost,
...
from nexuserp.setup.doctype.brand.brand import get_brand_defaults
from nexuserp.setup.doctype.item_group.item_group import get_item_group_defaults
from nexuserp.stock.doctype.batch.batch import get_batch_qty
from nexuserp.stock.doctype.item.item import get_item_defaults
from nexuserp.stock.doctype.serial_no.serial_no import get_serial_nos
from nexuserp.stock.doctype.stock_reconciliation.stock_reconciliation import (
...
from nexuserp.stock.serial_batch_bundle import (
	SerialBatchCreation,
	get_empty_batches_based_work_order,
	get_serial_or_batch_items,
)
from nexuserp.stock.stock_ledger import NegativeStockError, get_previous_sle, get_valuation_rate
from nexuserp.stock.utils import get_bin, get_combine_datetime, get_incoming_rate
...
from nexuserp.controllers.stock_controller import StockController
from nexuserp.controllers.subcontracting_inward_controller import SubcontractingInwardController
...
class StockEntry(StockController, SubcontractingInwardController):
	...
	if TYPE_CHECKING:
		...
		from nexuserp.stock.doctype.landed_cost_taxes_and_charges.landed_cost_taxes_and_charges import (
			LandedCostTaxesandCharges,
		)
		from nexuserp.stock.doctype.stock_entry_detail.stock_entry_detail import StockEntryDetail
	...
	def before_validate(self):
		from nexuserp.stock.doctype.putaway_rule.putaway_rule import apply_putaway_rule
	...
	def validate_difference_account(self):
		if not cint(nexuserp.is_perpetual_inventory_enabled(self.company)):
			return
	...
	def set_actual_qty(self):
		from nexuserp.stock.stock_ledger import is_negative_stock_allowed
	...
	def validate_same_source_target_warehouse_during_material_transfer(self):
		...
		if frappe.get_single_value("Stock Settings", "validate_material_transfer_warehouses"):
			from nexuserp.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
		...
		for d in self.get("items"):
			...
			if not d.basic_rate and not d.allow_zero_valuation_rate:
				...
				d.basic_rate = get_valuation_rate(
					...
					currency=nexuserp.get_company_currency(self.company),
					company=self.company,
	...
	def get_bom_raw_materials(self, qty):
		from nexuserp.manufacturing.doctype.bom.bom import get_bom_items_as_dict
	...
	def update_subcontracting_order_status(self):
		if self.subcontracting_order and self.purpose in ["Send to Subcontractor", "Material Transfer"]:
			from nexuserp.subcontracting.doctype.subcontracting_order.subcontracting_order import (
	...
	def update_pick_list_status(self):
		from nexuserp.stock.doctype.pick_list.pick_list import update_pick_list_status
...
def move_sample_to_retention_warehouse(company, items):
	...
	from nexuserp.stock.serial_batch_bundle import SerialBatchCreation
...
def get_expired_batch_items():
	from nexuserp.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import get_auto_batch_nos
...
def get_items_from_subcontract_order(source_name, target_doc=None):
	from nexuserp.controllers.subcontracting_controller import make_rm_stock_entry
