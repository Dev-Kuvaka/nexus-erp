...
from nexuserp.stock.doctype.material_request.material_request import (
	create_pick_list,
...
class TestMaterialRequest(IntegrationTestCase):
	...
	def test_partial_make_stock_entry(self):
		from nexuserp.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry as _make_stock_entry
	...
	def test_auto_email_users_with_company_user_permissions(self):
		from nexuserp.stock.reorder_item import get_email_list
	...
	def test_pending_qty_in_pick_list(self):
		...
		from nexuserp.stock.doctype.pick_list.pick_list import create_stock_entry
