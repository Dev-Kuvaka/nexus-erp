...
nexuserp.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
	constructor(opts) {
	...
	make_cards() {
		...
		chart_data.forEach((summary) => {
			let number_card = new nexuserp.accounts.NumberCard(summary);
...
nexuserp.accounts.NumberCard = class NumberCard {
	constructor(options) {
