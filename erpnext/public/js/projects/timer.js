frappe.provide("nexuserp.timesheet");

nexuserp.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	nexuserp.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

nexuserp.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
