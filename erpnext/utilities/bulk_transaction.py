...
def task(doc_name, from_doctype, to_doctype):
	from nexuserp.accounts.doctype.payment_entry import payment_entry
	from nexuserp.accounts.doctype.purchase_invoice import purchase_invoice
	from nexuserp.accounts.doctype.sales_invoice import sales_invoice
	from nexuserp.buying.doctype.purchase_order import purchase_order
	from nexuserp.buying.doctype.supplier_quotation import supplier_quotation
	from nexuserp.selling.doctype.quotation import quotation
	from nexuserp.selling.doctype.sales_order import sales_order
	from nexuserp.stock.doctype.delivery_note import delivery_note
	from nexuserp.stock.doctype.purchase_receipt import purchase_receipt
