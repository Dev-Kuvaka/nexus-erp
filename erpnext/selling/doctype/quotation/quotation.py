...
class Quotation(SellingController):
	...
	if TYPE_CHECKING:
		...
		from nexuserp.crm.doctype.competitor_detail.competitor_detail import CompetitorDetail
		from nexuserp.selling.doctype.quotation_item.quotation_item import QuotationItem
		from nexuserp.setup.doctype.quotation_lost_reason_detail.quotation_lost_reason_detail import (
...
def create_customer_from_lead(lead_name, ignore_permissions=False):
	from nexuserp.crm.doctype.lead.lead import _make_customer
...
def create_customer_from_prospect(prospect_name, ignore_permissions=False):
	from nexuserp.crm.doctype.prospect.prospect import make_customer as make_customer_from_prospect
